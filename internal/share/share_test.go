...
//
// The pure function and its Arabic-safety cases live with it in
// internal/pkg/bidi. What belongs HERE is the wiring: that the share
// handler actually calls it, on both fields, on the path a crawler takes.
//
