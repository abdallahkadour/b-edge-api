...
// ── Bidirectional control stripping ──────────────────────────────────────────

// stripBidiControls removes Unicode bidirectional override, embedding and
...
//	untouched. They are invisible, and they reorder the text AROUND them
//	when rendered. A bio of
//
